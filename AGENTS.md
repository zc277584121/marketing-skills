...
This is a skills repository for Claude Code, Codex CLI, and other coding agents. Each skill lives under `skills/<skill-name>/` with a `SKILL.md` and optional `references/` directory.
