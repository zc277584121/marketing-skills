...
3. **Review the article** against the style guidelines in the reference document.
4. **Make minimal, targeted adjustments** — only fix patterns that clearly feel AI-generated. If the article already reads naturally, leave it as-is.
5. **Preserve the original meaning and tone** — do not rewrite the article, just smooth out the AI-ish parts.
